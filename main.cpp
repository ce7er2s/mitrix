...
int main() {
    ...
    std::map<std::wstring, std::wstring> Help = {
            ...
            {L"multiply", 	L" номер_матрицы1 номер_матрицы2 номер_матрицы3 -- умножение матриц 1 и 2, и запись в матрицу3."},
            ...
            {L"matrix-=", 	L" номер_матрицы1 номер_матрицы2 -- вычитание матрицы 1 из матрицей 2. Результат в матрице1."},
            ...
            {L"submatrix", 	L" номер_матрицы1 номер_матрицы2 столбец строка -- нахождение подматрицы по координатам. Результат в матрице 2."},
            {L"copy", 		L" номер_матрицы1 номер_матрицы2 -- копирование матрицы 1 в матрицу 2. Имена не копируются."},
            {L"transpose", 	L" номер_матрицы1 -- транспонирование матрицы. Может менять размеры матрицы."},
